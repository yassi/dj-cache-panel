...
test_coverage:
	...
	@docker compose exec dev bash -c "cd /app && REDIS_HOST=redis python -m pytest --cov=dj_cache_panel --cov-report=xml --cov-report=html --cov-report=term-missing tests/"
